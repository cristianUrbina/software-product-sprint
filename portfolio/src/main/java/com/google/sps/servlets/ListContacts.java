...
public class ListContacts extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    Query<Entity> query =
        Query.newEntityQueryBuilder().setKind("Contact-info").setOrderBy(OrderBy.desc("last-name")).build();
    ...
    //   long id = entity.getKey().getId();
      String first_name = entity.getString("first-name");
      String last_name = entity.getString("last-name");
